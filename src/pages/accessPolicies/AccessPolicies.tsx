        ...
        <div style={{ marginBottom: '100px' }}>
          ...
          <div className="table-responsive">
            <table className="table table-striped table-responsive-sm">
              <thead>
                <tr>
                  <th>{I18n.t('dataCatalog.pages.mainPage.code')}</th>
                  <th>{I18n.t('dataCatalog.pages.mainPage.description')}</th>
                  <th>{I18n.t('dataCatalog.pages.mainPage.legalBasis')}</th>
                  <th>{I18n.t('dataCatalog.pages.mainPage.purposeCode')}</th>
                  <th>{I18n.t('dataCatalog.pages.mainPage.purposeDescription')}</th>
                </tr>
              </thead>
              <tbody>
                {!isPending
    ...
    return (
      <div>
        {getTable(
          ...
          'dataCatalog.pages.accessPolicies.accessPolicies'
        )}
      </div>
    );
  }
